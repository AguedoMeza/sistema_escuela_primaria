...
<body>
        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                     Listado de Directores Asignados.
    ...
    $qry = "SELECT usuarios.id, usuarios.nombre, usuarios.usuario,
            d_escuelas_directores.id   
            FROM usuarios 
            INNER JOIN d_escuelas_directores
            ON d_escuelas_directores.id_usuario = usuarios.id
            WHERE d_escuelas_directores.id_escuela =  '$id'";
                                ...
                                <table class="table">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td><a href="ejecutar_eliminar.php?id=<?php echo $row[3] ?>"><i class="fa fa fa-ban fa-2x color-icono" aria-hidden="true"></i></a></td>

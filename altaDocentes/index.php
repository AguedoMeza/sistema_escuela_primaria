                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                       ...
                       <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-bars"></i><a href="index.php">Crear Docente</a></li>
        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Victor Salomon</span> Listado de Docentes
                   ...
                   <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Alta de Docentes</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                        ...
                                        <form action="ejecutar_alta.php" method="POST" id="formulario">
                                             <div>
                                                    <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                        ...
                                                        <span id="payment-button-amount">Crear Docente</span>

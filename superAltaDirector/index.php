                   ...
                   <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Alta de Directores</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                        ...
                                        <form action="ejecutar_alta.php" method="POST" id="formulario">
                                             <div>
                                                    <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                        ...
                                                        <span id="payment-button-amount">Crear Director</span>
                                                        <span id="payment-button-sending" style="display:none;">Sending…</span>
                                                    </button>
                                                </div>
                                           
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Nombre del Director</label>

        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="indexAlumnos.php"> <i class="menu-icon fa fa-dashboard"></i>Panel de Alumno </a>
                    </li>
        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Victor Salomon</span> Listado.
             ...
             ?>
              <?php 
                ...
                $qry = "SELECT id, nombre, descripcion, fecha_cierre, enlace, activo, archivoPDF, imagen
                FROM contenidos
                WHERE id_materia = '$id'";
                                ...
                                <table class="table">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo $row[6]; ?>" download><i class="fa fa-file-word-o fa-2x color-icono" aria-hidden="true"></i></a></td>
                                            <td><a href="<?php echo $row[7]; ?>" download><i class="fa fa-cloud-download fa-2x color-icono" aria-hidden="true"></i></a></td>

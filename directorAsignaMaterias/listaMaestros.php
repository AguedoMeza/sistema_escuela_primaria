...
<body>
                    ...
                    <li class="active">
                     ...
                     <li class="menu-item-has-children dropdown">
                       ...
                       <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-bars"></i><a href="../altaDocentes/index.php">Alta de docentes</a></li>
                           
                            <li><i class="fa fa-bars"></i><a href="indexAsignar.php">Asignacion Grupos a Maestros</a></li>
                            <li><i class="fa fa-bars"></i><a href="../maestroContenido/indexMaestroContenido.php">Asignacion Materias a Grupos</a></li>
    ...
    $qry = "SELECT materias.id, materias.nombre,d_grupos_materias.id FROM materias 
            INNER JOIN d_grupos_materias
            ON d_grupos_materias.id_materia = materias.id
            WHERE d_grupos_materias.id_grupo = '$id'";
                                ...
                                <table class="table">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="ejecutar_eliminar.php?id=<?php echo $row[2] ?>"><i class="fa fa fa-ban fa-2x color-icono" aria-hidden="true"></i></a></td>

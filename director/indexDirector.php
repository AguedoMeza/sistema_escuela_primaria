                                        ...
                                        <form action="ejecutar_alta.php" method="POST" id="formulario">
                                             <div>
                                                    <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                        ...
                                                        <span id="payment-button-amount">Crear Grupo</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="txtGrupo" name="txtGrupo" type="text" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
